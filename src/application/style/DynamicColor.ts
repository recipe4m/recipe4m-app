...
export interface Color {
  ...
  HEADER_BUTTON_LABEL_ACTIVE: string;
  HEADER_BUTTON_ICON: string;
  HEADER_BUTTON_ICON_ACTIVE: string;
...
const LightDynamicColor: Color = {
  ...
  HEADER_BACKGROUND: ColorPalette.WHITE,
  HEADER_BORDER: ColorPalette.GRAY_300,
  HEADER_BUTTON_LABEL: ColorPalette.GRAY_500,
  HEADER_BUTTON_LABEL_ACTIVE: ColorPalette.ORANGE_300,
  HEADER_BUTTON_ICON: ColorPalette.GRAY_500,
  HEADER_BUTTON_ICON_ACTIVE: ColorPalette.ORANGE_300,
  ...
  FLOATING_TIMER_BACKGROUND: ColorPalette.ORANGE_200,
  FLOATING_TIMER_BORDER: ColorPalette.ORANGE_100,

  PROGRESS_BAR_BACKGROUND: ColorPalette.ORANGE_100,
};
...
const DarkDynamicColor: Color = {
  ...
  HEADER_BACKGROUND: ColorPalette.BLACK,
  HEADER_BORDER: ColorPalette.GRAY_700,
  HEADER_BUTTON_LABEL: ColorPalette.GRAY_500,
  HEADER_BUTTON_LABEL_ACTIVE: ColorPalette.ORANGE_300,
  HEADER_BUTTON_ICON: ColorPalette.GRAY_500,
  HEADER_BUTTON_ICON_ACTIVE: ColorPalette.ORANGE_300,
